...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        String filePath = canonicalPath+"\\boyue\\myBatisPlus-generator\\src\\main\\";
        ...
        dsc.setUrl("jdbc:mysql:///boyue_shop?useUnicode=true&characterEncoding=utf8");
        ...
        // 设置Entity包名，默认entity,继承的父类  已序列化
        pc.setEntity("entity");
